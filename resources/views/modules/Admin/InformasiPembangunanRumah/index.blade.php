...
<div class="row justify-content-center">
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="card-body">
                <a href="{{route('admin.info-pembangunan-rumah.create')}}" class="btn btn-primary">Tambah Informasi
                    Pembangunan Rumah</a>
                <hr>
                @if(!empty($model))
                <table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <form action="{{route('admin.info-pembangunan-rumah.delete',  ['id' => $data->id])}}"
                                      method="post">
                                    @csrf
                                    @method('delete')
                                    <a href="{{route('admin.info-pembangunan-rumah.detail', ['id' => $data->id])}}"
                                        class="btn btn-primary btn-xs"><i class="fa fa-file"></i> Detail</a>
                                     <a href="{{route('admin.info-pembangunan-rumah.edit', ['id' => $data->id])}}"
