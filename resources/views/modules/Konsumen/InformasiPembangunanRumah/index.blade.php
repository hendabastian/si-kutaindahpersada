                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <form action="{{route('konsumen.info-pembangunan-rumah.delete',  ['id' => $data->id])}}"
                                      method="post">
                                    @csrf
                                    @method('delete')
                                    <a href="{{route('konsumen.info-pembangunan-rumah.detail', ['id' => $data->id])}}"
                                        class="btn btn-primary btn-xs"><i class="fa fa-file"></i> Detail</a>
                                     <a href="{{route('konsumen.info-pembangunan-rumah.edit', ['id' => $data->id])}}"
