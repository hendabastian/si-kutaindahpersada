...
<div class="row justify-content-center">
    ...
    <div class="col-md-8">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{route('konsumen.info-pembangunan-rumah.delete',  ['id' => $model->id])}}"
                      method="post">
                    @csrf
                    @method('delete')
                    <a href="{{route('konsumen.info-pembangunan-rumah.detail', ['id' => $model->id])}}"
                       class="btn btn-primary btn-xs"><i class="fa fa-file"></i> Detail</a>
                    <a href="{{route('konsumen.info-pembangunan-rumah.edit', ['id' => $model->id])}}"
