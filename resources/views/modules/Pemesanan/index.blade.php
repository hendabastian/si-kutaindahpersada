...
<div class="row justify-content-center">
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="card-body">
                <a href="{{route('pemesanan.create')}}" class="btn btn-primary">Tambah
                    Pemesanan</a>
                <hr>
                @if(!empty($model))
                <table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <form action="{{route('pemesanan.delete',  ['id' => $data->id])}}"
                                      method="post">
                                    @csrf
                                    @method('delete')
                                    <a href="{{route('pemesanan.detail', ['id' => $data->id])}}"
                                        class="btn btn-primary btn-xs"><i class="fa fa-file"></i> Detail</a>
                                     <a href="{{route('pemesanan.edit', ['id' => $data->id])}}"
