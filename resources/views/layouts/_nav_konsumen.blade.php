        ...
        <ul class="metismenu" id="menu">
            ...
            <li class="{{(Request::is('konsumen/pemesanan/*') ? 'active' : '')}}">
                ...
                <ul aria-expanded="false">
                    <li class="{{(Request::is('konsumen/pemesanan/*') ? 'active' : '')}}">
                        <a class="{{(Request::is('konsumen/pemesanan/*') ? 'active' : '')}}" href="{{route('konsumen.pemesanan.index')}}">Data Pemesanan</a>
                    </li>
            ...
            <li class="{{(Request::is('konsumen/surat-perintah-kerja/*')) ? 'active' : ''}}">
                <a href="{{route('konsumen.surat-perintah-kerja.index')}}" aria-expanded="false">
