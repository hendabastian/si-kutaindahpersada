...
class InformasiPembangunanRumahController extends Controller
{
    public function index()
    {
        ...
        return view('modules.Konsumen.InformasiPembangunanRumah.index', [
            'model' => $model,
    ...
    public function create(Request $request)
    {
        ...
        return view('modules.Konsumen.InformasiPembangunanRumah.create', [
    ...
    public function detail($id) 
    {
        ...
        return view('modules.Konsumen.InformasiPembangunanRumah.detail', [
            'model' => $model,
            'title' => $model->id
        ]);
    }
    ...
    public function edit($id, Request $request)
    {
        ...
        return view('modules.Konsumen.InformasiPembangunanRumah.edit', [
            'model' => $model,
